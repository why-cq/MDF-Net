...
class Trainer(object):
    def __init__(self, args):
        ...
        self.val_evaler = Evaler(
            ...
            extract_feature_files='./mscoco/feature/CLIP-B-16-196/clip_feature_val'   # 原始的pure不需要这个特征,直接从s-t中
        ...
        self.test_evaler = Evaler(
            ...
            extract_feature_files= './mscoco/feature/CLIP-B-16-196/clip_feature_test'
        )
        self.scorer = Scorer()
    ...
    def setup_dataset(self):
        ...
        self.coco_set = Clip_coco_dataset.ClipCocoDataset(
            ...
            seq_per_img = cfg.DATA_LOADER.SEQ_PER_IMG,
            max_feat_num = cfg.DATA_LOADER.MAX_FEAT,
            extract_feature_files='./mscoco/feature/CLIP-L-14/clip_feature_train'
...
def parse_args():
    ...
    parser.add_argument('--folder', dest='folder', type=str, default="experiment_MyModels/ACT/aling_adaptive_SCST")
    parser.add_argument("--local_rank", type=int, default=0)
    parser.add_argument("--resume", type=int, default=24)  # resume 的值就是最后训练的epoch的值
