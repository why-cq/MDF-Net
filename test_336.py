...
class Tester(object):
    def __init__(self, args):
        ...
        self.evaler = Evaler(
            ...
            extract_feature_files=r'F:\VIT-L-336\val2014'
        )
        # 验证集
        # self.evaler = Evaler(
        ...
        #     eval_ids=cfg.DATA_LOADER.VAL_4W_ID, # './mscoco/misc/ids2path_json/coco_val4w_ids2path.json'
        #     gv_feat=cfg.DATA_LOADER.TEST_GV_FEAT,
        #     att_feats=cfg.DATA_LOADER.TEST_ATT_FEATS,
        #     # eval_annfile=cfg.INFERENCE.TEST_ANNFILE,
        #     extract_feature_files='/mnt/usb/CLIP_features/VIT-L-336/val2014' # '/mnt/usb/CLIP_features/VIT-L-336/val2014'
        # )
...
def parse_args():
    ...
    parser.add_argument('--folder', dest='folder', default="experiment_MyModels/ACT", type=str)
    parser.add_argument("--resume", type=int, default=34)
