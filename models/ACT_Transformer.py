...
from models.CLIP_swim_transform import subsequent_mask
from models.Decoder_DIY.decocer_CMPA import Decoder_CMPA, Decoder_CMPA_2, Decoder_CMPA_ONE
...
from models.encoder_decoder.CLIP_encoder_decoder.CLIP_encoder import Encoder, Encoder_AEF, Encoder_M, Encoder_adaptive
...
# 这个的多层编码器是最开始的版本
class ACT_Transformer(BasicModel):
    def __init__(self):
...
class ACT_Transformer_adaptive(BasicModel):
    def __init__(self):
        super(ACT_Transformer_adaptive, self).__init__()
        self.vocab_size = cfg.MODEL.VOCAB_SIZE + 1
...
class ACT_Transformer_adaptive_336(BasicModel):
    def __init__(self):
        super(ACT_Transformer_adaptive_336, self).__init__()
        self.vocab_size = cfg.MODEL.VOCAB_SIZE + 1
