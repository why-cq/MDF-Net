...
from models.Decoder_DIY.decocer_CMPA import Decoder_CMPA, Decoder_CMPA_ONE
from models.Decoder_DIY.decoder_v1 import Decoder_v1
from models.Decoder_DIY.decoder_v2 import Decoder_v2
...
from models.encoder_decoder.CLIP_encoder_decoder.CLIP_encoder import Encoder, Encoder_AEF, Encoder_M
...
'''
这里的模型仅仅改用了CLIP的特征,应为CLIP的视觉编码器出来的特征维度和swim-transformer出来的不一样`
修改气候的全连接层其他的结构没有改变
'''
class CLIP_Transformer_196_decoder_v1(BasicModel):
    def __init__(self):
        super(CLIP_Transformer_196_decoder_v1, self).__init__()
    ...
    def forward(self, **kwargs):
        ...
        decoder_out = self.decoder(gx, seq, encoder_out, seq_mask, att_mask)   # 解码器需要全局特征
        # decoder_out = self.decoder(seq, encoder_out, seq_mask, att_mask)        # 解码器无需全局特征
...
class CLIP_Transformer_196_decoder_v2(BasicModel):
    def __init__(self):
        super(CLIP_Transformer_196_decoder_v2, self).__init__()
        self.vocab_size = cfg.MODEL.VOCAB_SIZE + 1
...
class CLIP_Transformer_196_encoder_M(BasicModel):
    def __init__(self):
        super(CLIP_Transformer_196_encoder_M, self).__init__()
        self.vocab_size = cfg.MODEL.VOCAB_SIZE + 1
...
class CLIP_Transformer_196(BasicModel):
    def __init__(self):
        super(CLIP_Transformer_196, self).__init__()
        self.vocab_size = cfg.MODEL.VOCAB_SIZE + 1
...
class CLIP_Transformer_49(BasicModel):
    def __init__(self):
        super(CLIP_Transformer_49, self).__init__()
        self.vocab_size = cfg.MODEL.VOCAB_SIZE + 1
        ...
        self.encoder = Encoder(
            embed_dim=cfg.MODEL.ATT_FEATS_EMBED_DIM,
            input_resolution=(7, 7),   # 输入的grid特征
            depth=cfg.MODEL.BILINEAR.ENCODE_LAYERS,
            num_heads=cfg.MODEL.BILINEAR.HEAD,
            window_size=1,
            shift_size=0,
...
class CLIP_Transformer_L_256(BasicModel):
    def __init__(self):
        super(CLIP_Transformer_L_256, self).__init__()
        self.vocab_size = cfg.MODEL.VOCAB_SIZE + 1
...
class CLIP_Transformer_L_256_M(BasicModel):
    def __init__(self):
        super(CLIP_Transformer_L_256_M, self).__init__()
        self.vocab_size = cfg.MODEL.VOCAB_SIZE + 1
...
class CLIP_Transformer_AEF(BasicModel):
    def __init__(self):
        super(CLIP_Transformer_AEF, self).__init__()
        self.vocab_size = cfg.MODEL.VOCAB_SIZE + 1
...
class CLIP_Transformer_CMPA(BasicModel):
    def __init__(self):
        super(CLIP_Transformer_CMPA, self).__init__()
        self.vocab_size = cfg.MODEL.VOCAB_SIZE + 1
