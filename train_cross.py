...
def parse_args():
    ...
    parser.add_argument('--folder', dest='folder', type=str, default="experiment_MyModels/ACT/align_XE")
    parser.add_argument("--local_rank", type=int, default=0)
    parser.add_argument("--resume", type=int, default=0)  # resume 的值就是最后训练的epoch的值
