...
__C.DATA_LOADER.VAL_4W_ID = './mscoco/misc/ids2path_json/coco_val4w_ids2path.json'

__C.DATA_LOADER.INPUT_SEQ_PATH = 'coco_train_input.pkl'

__C.DATA_LOADER.TARGET_SEQ_PATH = 'coco_train_target.pkl'

__C.DATA_LOADER.SEQ_PER_IMG = 5  # 每张图片5个句子
...
__C.MODEL.ATT_FEATS_DIM = 2048  # 这个是基础模型去掉分类头出来的特征维度

__C.MODEL.ATT_FEATS_EMBED_DIM = 512  # 自己的模型需要输入的维度,大家都用512
...
__C.SOLVER.SNAPSHOT_ITERS = 3   # 每经过几个epoch保存快照
